            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                    {!! Form::open(['id' => 'dataForm', 'url' => 'section/save']) !!}
                           ...
                           <div class="form-group">
                                ...
                                {!!Form::text('section',null, ['placeholder' => 'Section', 'class' => 'form-control col-lg-12', 'required' => '' ])!!}
                           </div>
                                {!!Form::submit('Create Section', ['id' => 'addForm','class' => 'btn btn-primary  col-lg-2 offset-7']) !!}
